...
RichGetRicher.description = "+1 for every <color=money><font=big>9$<color=white><font=default> you have (min 1)";
...
function RichGetRicher.new()
    ...
    local bonus = math.max(math.floor(Player.realMoney / 9), 1);
